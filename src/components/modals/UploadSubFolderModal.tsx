...
import {setSubFolderName} from '../../redux/renameSubFolderSlice.ts';
...
export const UploadSubFolderModal = ({
  ...
  const handleCreateFolder = async () => {
    ...
    try {
      ...
      await setDoc(doc(subfolderRef), newSubfolder);
      dispatch(setSubFolderName(''));
        ...
        <Animated.View style={[styles.modalContainer, {transform: [{translateX: slideAnim}]}]}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalTitleContainer}>
              <Text style={styles.modalTitleText}>Create A New Subfolder!</Text>
            </View>
            ...
            <View style={styles.inputFieldsAndButtons}>
              <View style={styles.inputFieldsContainer}>
                <TextInput
                  style={styles.input}
                  placeholder="Subfolder Name  (e.g. Mixes)"
